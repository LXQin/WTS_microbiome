...
chm13_dir="home/nfs/pengy3/microbiome/CHM13/index/chm13v2.0"
...
bowtie2 -x "$chm13_dir" -1 "${input_dir}/${sample_id}_unmapped_1.fastq" -2 "${input_dir}/${sample_id}_unmapped_2.fastq" -p 8 | \
